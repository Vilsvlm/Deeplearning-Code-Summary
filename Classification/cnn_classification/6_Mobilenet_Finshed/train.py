...
def main():
    ...
    pre_weights_items = pre_weights.items()
    # delete classifier weights
    pre_dict = {k: v for k, v in pre_weights_items if net_state_dict[k].numel() == v.numel()}
    ...
    net_features_parameters = net.features.parameters()
    # freeze features weights
    for param in net_features_parameters:
    ...
    best_acc = 0.0
    save_path = './MobileNetV3.Self.pth'
